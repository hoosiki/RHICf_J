...
G4VPhysicalVolume* RHICFDetectorConstructionTOPwoW::Construct ( )
{
    ...
    RHICFManager::GetInstance()->SetARM1Y((30.1*sqrt(2)+5+24)/10.);//TOP CENTER
    //Junsang****RHICFManager::GetInstance()->SetARM1Y((30.1*sqrt(2)+5)/10.);//TS CENTER
    //Junsang****RHICFManager::GetInstance()->SetARM1Y(0.);//TL CENTER
...
void RHICFDetectorConstructionTOPwoW::DefineDimension()
{
...
void RHICFDetectorConstructionTOPwoW::ConstructMaterials ( )
{
}

void RHICFDetectorConstructionTOPwoW::DestructMaterials ( )
{
}

G4Material* RHICFDetectorConstructionTOPwoW::FindMaterial(G4String name)
{
...
//
//
void RHICFDetectorConstructionTOPwoW::PHENIXZDCINSTALL(G4VPhysicalVolume* world_phys, G4ThreeVector vector, G4RotationMatrix* mat)
{
...
void RHICFDetectorConstructionTOPwoW::STARZDCINSTALL(G4VPhysicalVolume* world_phys, G4ThreeVector vector, G4RotationMatrix* mat)
{
...
void RHICFDetectorConstructionTOPwoW::PHENIXPIPE()
{
    /*-*///----------------------------------------------BEAM PIPE----------------------------------------------------
    /*-*/par[0] = 0.0;
    /*-*/par[1] = 0.1;
...
void RHICFDetectorConstructionTOPwoW::ARM1INSTALL(G4VPhysicalVolume* world_phys, G4ThreeVector vector, G4RotationMatrix* mat)
{
    /*-*/// Define ARM1
...
void RHICFDetectorConstructionTOPwoW::STARPIPEINSTALL(G4double arm1y, G4double arm1z)
{
    //------------------------------------------------UPSTREAM SECTION---------------------------------------
