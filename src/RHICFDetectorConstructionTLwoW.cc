...
void RHICFDetectorConstructionTLwoW::DefineDimension()
{
...
void RHICFDetectorConstructionTLwoW::ConstructMaterials ( )
{
}

void RHICFDetectorConstructionTLwoW::DestructMaterials ( )
{
}

G4Material* RHICFDetectorConstructionTLwoW::FindMaterial(G4String name)
{
...
//
//
void RHICFDetectorConstructionTLwoW::PHENIXZDCINSTALL(G4VPhysicalVolume* world_phys, G4ThreeVector vector, G4RotationMatrix* mat)
{
...
void RHICFDetectorConstructionTLwoW::STARZDCINSTALL(G4VPhysicalVolume* world_phys, G4ThreeVector vector, G4RotationMatrix* mat)
{
...
void RHICFDetectorConstructionTLwoW::PHENIXPIPE()
{
    /*-*///----------------------------------------------BEAM PIPE----------------------------------------------------
    /*-*/par[0] = 0.0;
    /*-*/par[1] = 0.1;
...
void RHICFDetectorConstructionTLwoW::ARM1INSTALL(G4VPhysicalVolume* world_phys, G4ThreeVector vector, G4RotationMatrix* mat)
{
    /*-*/// Define ARM1
...
void RHICFDetectorConstructionTLwoW::STARPIPEINSTALL(G4double arm1y, G4double arm1z)
{
    //------------------------------------------------UPSTREAM SECTION---------------------------------------
