...
G4VPhysicalVolume* RHICFDetectorConstruction::STARPIPE(G4ThreeVector vector)
{
    ...
    auto f3InchShortPhysical = new G4PVPlacement(fNonRotation, G4ThreeVector(0.*cm, 0*cm, -194.7955*cm), "3InchShortPhysical", f3InchShortLogical, fWorldLogical, false, 0, checkOverlaps);
    starpar[0] = 3.54;
    starpar[1] = 3.81;
    starpar[2] = 362.337;
    starpar[3] = 0;
