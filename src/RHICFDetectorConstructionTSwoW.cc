...
void RHICFDetectorConstructionTSwoW::DefineDimension()
{
...
void RHICFDetectorConstructionTSwoW::ConstructMaterials ( )
{
}

void RHICFDetectorConstructionTSwoW::DestructMaterials ( )
{
}

G4Material* RHICFDetectorConstructionTSwoW::FindMaterial(G4String name)
{
...
//
//
void RHICFDetectorConstructionTSwoW::PHENIXZDCINSTALL(G4VPhysicalVolume* world_phys, G4ThreeVector vector, G4RotationMatrix* mat)
{
...
void RHICFDetectorConstructionTSwoW::STARZDCINSTALL(G4VPhysicalVolume* world_phys, G4ThreeVector vector, G4RotationMatrix* mat)
{
...
void RHICFDetectorConstructionTSwoW::PHENIXPIPE()
{
    /*-*///----------------------------------------------BEAM PIPE----------------------------------------------------
    /*-*/par[0] = 0.0;
    /*-*/par[1] = 0.1;
...
void RHICFDetectorConstructionTSwoW::ARM1INSTALL(G4VPhysicalVolume* world_phys, G4ThreeVector vector, G4RotationMatrix* mat)
{
    /*-*/// Define ARM1
...
void RHICFDetectorConstructionTSwoW::STARPIPEINSTALL(G4double arm1y, G4double arm1z)
{
    //------------------------------------------------UPSTREAM SECTION---------------------------------------
