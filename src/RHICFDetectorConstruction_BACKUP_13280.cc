...
///////////////////////////////////////////////////////////////////////////////
{
    ...
    SMDV1Rotation            = new G4RotationMatrix();

    SMDV1Rotation            -> rotateZ(90*deg);
    SMDV2Rotation            = new G4RotationMatrix();
    SMDV2Rotation            -> rotateZ(-90*deg);
    ...
    for(G4int i=1; i<22; i++)
    {
        ...
        {
            xpos                = 0.5*(i-11);
            new G4PVPlacement(SMDV1Rotation, G4ThreeVector(xpos*cm, 0.36*cm, 0.*cm), fSMDVLogical, "SMDVPhysical", fSMDLogical, true, i, checkOverlaps);
        }
        ...
        {
            xpos                = 0.5*i-5.5;
            new G4PVPlacement(SMDV2Rotation, G4ThreeVector(xpos*cm, 0.36*cm, 0.*cm), fSMDVLogical, "SMDVPhysical", fSMDLogical, true, i, checkOverlaps);
        }
    }
